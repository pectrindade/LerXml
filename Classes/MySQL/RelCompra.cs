...
namespace LerXML.Classes.MySQL
{
    ...
    public class RelCompra
    {
        ...
        public int InsertAccess_RelCompra(string ano, string numeronf, string dataemissao, string emicnpj, string eminome, string destcnpj, string destnome, string chave, string nomeproduto, string quantidade,
